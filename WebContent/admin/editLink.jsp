				...
				<section class="blockGroup">
					...
					<form class="form-horizontal" style="padding-left: 100px;" action="${APP_PATH}/admin/updateLink" method="post">
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-6">
					      <input type="text" class="form-control" name="linkname" value="${link.linkname }" placeholder="linkname">
					    </div>
					  </div>
					  <div class="form-group">
					    <label for="inputPassword" class="col-sm-2 control-label">友链地址</label>
					    <div class="col-sm-6">
					      <input type="url" class="form-control" name="linkurl" value="${link.linkurl }" placeholder="linkurl">
					    </div>
					  </div>
					  <div class="form-group">
